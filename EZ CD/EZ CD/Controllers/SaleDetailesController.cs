...
namespace EZ_CD.Controllers
{
    public class SaleDetailesController : Controller
    {
        ...
        public SaleDetailesController(EZ_CDContext context)
        {
            _context = context;
        }
        ...
        {
            var eZ_CDContext = _context.SaleDetailes.Include(s => s.disk).Include(s => s.sale);
            return View(await eZ_CDContext.ToListAsync());
        }
        ...
        {
            ViewData["diskId"] = new SelectList(_context.Set<Disk>(), "diskId", "diskId");
        ...
        public async Task<IActionResult> Create([Bind("diskId,saleId")] SaleDetailes saleDetailes)
        {
            ...
            ViewData["diskId"] = new SelectList(_context.Set<Disk>(), "diskId", "diskId", saleDetailes.diskId);
            ViewData["saleId"] = new SelectList(_context.Set<Sale>(), "saleId", "saleId", saleDetailes.saleId);
            return View(saleDetailes);
        }
